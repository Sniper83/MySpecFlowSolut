...
namespace MySpecFlowProj.Tests
{
    ...
    [NUnit.Framework.DescriptionAttribute("CorrectTextInElements")]
    public partial class CorrectTextInElementsFeature
    {
...
#line 1 "CorrectTextInElements.feature"
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Get some element")]
        [NUnit.Framework.CategoryAttribute("mytag3")]
        [NUnit.Framework.TestCaseAttribute("Images", null)]
        [NUnit.Framework.TestCaseAttribute("SignIn", null)]
        public virtual void GetSomeElement(string element, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get some element", null, @__tags);
#line 10
